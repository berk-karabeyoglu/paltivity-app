...
export default function ChangePasswordScreen() {
  ...
  const handleSubmit = async () => {
    ...
    if (currentPw === newPw) {
      setCurrentError('Yeni şifre mevcut şifrenden farklı olmalı.')
      return
    }
    ...
    try {
      ...
      if (signInError) {
        setCurrentError('Mevcut şifre yanlış.')
        return
      }
      ...
      Alert.alert('Başarılı', 'Şifren güncellendi.', [
        { text: 'Tamam', onPress: () => router.replace('/settings') },
      ])
    } catch (e: any) {
      ...
      >
        ...
        <View style={styles.body}>
          <Text style={styles.hint}>
            Güvenliğin için önce mevcut şifreni gir, ardından yeni şifreni belirle.
          </Text>
          ...
          <View>
            ...
            <View style={[
              ...
              currentError ? styles.inputRowError : {},
            ]}>
              <TextInput
                style={styles.input}
                value={currentPw}
                onChangeText={v => { setCurrentPw(v); setCurrentError('') }}
          ...
          >
            {loading
              ...
              : <Text style={styles.submitLabel}>Şifreyi Güncelle</Text>
            }
          </TouchableOpacity>
        </View>
      </ScrollView>
